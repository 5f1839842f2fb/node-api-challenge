...
- [ ] Describe Middleware?
    - Middleware is code that can modify, log, or stop requests before sending them on.
- [ ] Describe a Resource?
    - A resource is a piece or pieces of data that the client gets when accessing an endpoint successfully.
- [ ] What can the API return to help clients know if a request was successful?
    - A 200 status code indicates success.
- [ ] How can we partition our application into sub-applications?
    - Moving routes into their own file (module), grouped by endpoint type.
